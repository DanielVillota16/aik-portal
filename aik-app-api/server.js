...
var connection = mysql.createConnection({
  ...
  password : process.env.DB_PASS || 'stigma1234',
...
connection.connect(function(err) {
  ...
  /**
   * NOTA:
   * EL SIGUIENTE BLOQUE PUEDEN DEJARLO COMO PARTE DE LA APLICACION O CREAR UN SCRIPT EN BASH QUE SE CONECTE DIRECTAMENTE A LA DB
   * Y AGREGUE TODA LA INFORMACIÓN NECESARIA 
   */
